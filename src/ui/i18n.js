...
(function (global) {
  ...
  const dict = {
    zh: {
      ...
      'home.intro': '从一首歌开始。粘贴 Apple Music 歌曲或 MV 链接，探索每一种音质，在浏览器里聆听，或下载收藏。',
      'home.formHint': '支持歌曲、MV 链接、带 ?i= 的专辑分享链接及歌曲 ID',
      'home.step1': '粘贴歌曲链接',
      'home.step2': '选择喜欢的音质',
      'home.step3': '播放，或下载收藏',
      'home.inputLabel': '歌曲 / MV 链接或歌曲 ID',
      'home.submit': '探索音质',
      'home.example': '示例：',
      'home.recent': '最近解析',
      'home.clear': '清空',
      'home.invalid': '无法识别：请输入 song / music-video 链接、带 ?i= 的专辑链接或纯数字歌曲 ID。',
    ...
    en: {
      ...
      'home.formHint': 'Song or music-video links, album links with ?i=, or a song ID',
      'home.step1': 'Paste a song link',
      'home.step2': 'Find your audio quality',
      'home.step3': 'Listen or download',
      'home.inputLabel': 'Song / MV link or song ID',
      'home.submit': 'Explore',
      'home.example': 'Example: ',
      'home.recent': 'Recent',
      'home.clear': 'Clear',
      'home.invalid': 'Unrecognized input: enter a song or music-video link, an album link with ?i=, or a numeric song ID.',
